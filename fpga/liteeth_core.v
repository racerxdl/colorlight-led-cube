...
reg [23:0] arp_table_request_timer_count = 24'd15000000;
...
reg [30:0] arp_table_cached_timer_count = 31'd1500000000;
...
always @(posedge sys_clk) begin
	...
	if (arp_table_request_timer_wait) begin
		...
		arp_table_request_timer_count <= 24'd15000000;
	end
	if (arp_table_cached_timer_wait) begin
		...
		arp_table_cached_timer_count <= 31'd1500000000;
	end
